...
class CalcCtrl {
	...
	public function process(){
		...
		if ($this->validate()) {
			...
			$this->result->procenty = $this->form->proc * 0.01;
			$this->result->procenty = $this->result->procenty * $this->form->lata;
			$this->result->oprocentowanie = $this->result->procenty * $this->form->kwota;
			$this->result->result = $this->result->oprocentowanie + $this->form->kwota;
			$this->result->result = round($this->result->result / 12,2);
	...
	public function generateView(){
		...
		$smarty->assign('page_title','Przykład 05 MR');
