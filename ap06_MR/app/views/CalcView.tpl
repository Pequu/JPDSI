...
{block name=content}
	...
	<section id="log-info" style="padding-right:0.5em">
		użytkownik: <span style="font-weight: 400">{$user->login}</span>, rola: <span style="font-weight: 400">{$user->role}&nbsp;&nbsp;&nbsp;
		<a href="{$conf->action_url}logout"  class="">wyloguj</a></span>
	</section>
	</div>
...
<!-- Header -->
			<div id="header">
				...
				<div class="top">
					...
					<!-- Logo -->
						<div id="logo">
							<span class="image avatar48"><img src="{$conf->app_url}/images/avatar.jpg" alt="" /></span>
				...
				<!-- About Me -->
					<section id="about" class="three">
						<div class="container">
							...
							<a href="#" class="image featured"><img src="{$conf->app_url}/images/pic08.jpg" alt="" /></a>
